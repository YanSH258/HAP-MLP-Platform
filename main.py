...
from modules.workflows import run_stage_1_generate, run_stage_2_collect, run_stage_3_analysis
...
if __name__ == "__main__":
    ...
    if args.stage == 1:
        ...
        run_stage_3_analysis(mode=args.mode)